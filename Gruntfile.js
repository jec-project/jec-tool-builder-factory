/*!
 * JEC Builder Factory Gruntfile.js
...
/*
 * Provides tasks for building and testing the jec-tool-builder-factory project.
 */
module.exports = function(grunt) {
  ...
  grunt.config("typedoc", {
    doc: {
      ...
      options: {
        ...
        readme: "README.md",
        name: "JEC Builder Factory Project",
        exclude: "**/*Test*.ts"
      }
    }
  });
  ...
  /*!
   * JEC Builder Factory Tasks:
   */

  //--> Task: builds the "jec-tool-builder-factory" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-tool-builder-factory" API documentation:
